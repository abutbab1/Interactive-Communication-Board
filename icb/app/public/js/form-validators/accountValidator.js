...
// build array maps of the form inputs & control groups //
	...
	this.formFields = [$('#name-tf'), $('#email-tf'), $('#user-tf'), $('#pass-tf'), $('#pass-cn')];
	this.controlGroups = [$('#name-cg'), $('#email-cg'), $('#user-cg'), $('#pass-cg'), $('#pass-cncg')];
...
// bind the form-error modal window to this controller to display any errors //
	...
	this.validatePasswords = function(s, f)
	{
		if ($('#pass-tf').val() == $('#pass-cn').val())
		{
			return false;
		}
		else
